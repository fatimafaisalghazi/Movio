...
class GetExploreMoreMovieUseCaseTest {
    ...
    @Test
    fun `invoke SHOULD call repository getExploreMoreMovies with page 1`() = runTest {
        val page = 1
    ...
    @Test
    fun `invoke SHOULD call repository getExploreMoreMovies with different page`() = runTest {
        val page = 5
        val expectedResult = emptyList<Movie>()
        coEvery { movieRepository.getExploreMoreMovies(page) } returns expectedResult
    ...
    @Test
    fun `invoke SHOULD call repository getExploreMoreMovies with large page number`() = runTest {
        val page = 1000
        val expectedResult = emptyList<Movie>()
        coEvery { movieRepository.getExploreMoreMovies(page) } returns expectedResult
