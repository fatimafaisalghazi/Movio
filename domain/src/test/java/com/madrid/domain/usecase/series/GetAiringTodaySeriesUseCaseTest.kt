...
class GetAiringTodaySeriesUseCaseTest {
    ...
    @Test
    fun `invoke SHOULD call repository getAiringTodaySeries with page`() = runTest {
        val page = 1
    ...
    @Test
    fun `invoke SHOULD call repository getAiringTodaySeries with first page`() = runTest {
        val page = 1
        val expectedResult = emptyList<Series>()
        coEvery { seriesRepository.getAiringTodaySeries(page) } returns expectedResult
    ...
    @Test
    fun `invoke SHOULD call repository getAiringTodaySeries with multiple pages`() = runTest {
        val page = 5
        val expectedResult = emptyList<Series>()
        coEvery { seriesRepository.getAiringTodaySeries(page) } returns expectedResult
    ...
    @Test
    fun `invoke SHOULD call repository getAiringTodaySeries with large page number`() = runTest {
        val page = 999
        val expectedResult = emptyList<Series>()
        coEvery { seriesRepository.getAiringTodaySeries(page) } returns expectedResult
