...
class GetAllSeriesInHistoryUseCaseTest {
    ...
    @Test
    fun `invoke SHOULD call repository getAllSeriesInHistory and return series list`() = runTest {
    ...
    @Test
    fun `invoke SHOULD return empty list when no series in history`() = runTest {
    ...
    @Test
    fun `invoke SHOULD return single series when only one in history`() = runTest {
        val expectedSeries = listOf(
            Series(
                id = 1,
                title = "Single Series",
    ...
    @Test
    fun `invoke SHOULD return multiple series when many in history`() = runTest {
